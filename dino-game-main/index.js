...
function selectMenu1(page) {
    const content1 = document.getElementById('content1');
    if (content1) {
        content1.innerHTML = `<iframe src="${page}" style="width:100%; height:500px;"></iframe>`;
    } else {
        console.error('content1 요소를 찾을 수 없습니다.');
    }
}
...
function logout() {
    ...
    localStorage.setItem('Lin', 'false');
}
